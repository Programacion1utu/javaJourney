...
,  // ══ TEMA 31: Desafíos Finales ═════════════════════════════════════════════════
  {
 id: 61, title: "Patrón de números", subtitle: "Triángulo numérico",    explanation: `<h2 class="text-base font-bold mb-3">Desafío: Patrón de números</h2><p class="text-slate-300 text-sm mb-4">Usar bucles anidados para imprimir un triángulo donde cada fila muestra los números del 1 hasta el número de la fila.</p><div class="bg-slate-800/60 rounded-lg p-4 mb-4 mono text-sm text-slate-300 leading-7"><div class="text-[10px] uppercase tracking-wider text-slate-500 mb-2 font-semibold not-italic">Ejemplo</div><span class="text-slate-500">// Salida esperada:</span><br><span class="text-orange-300">1</span><br><span class="text-orange-300">1 2</span><br><span class="text-orange-300">1 2 3</span><br><span class="text-orange-300">1 2 3 4</span><br><span class="text-orange-300">1 2 3 4 5</span></div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> El código ya está completo. Ejecutar y verificar que imprime el triángulo numérico de 5 filas (cada fila del 1 hasta el número de fila).</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">1<br>1 2<br>1 2 3<br>1 2 3 4<br>1 2 3 4 5</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
