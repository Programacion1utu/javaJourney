...
</div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> Declarar <code class="text-indigo-300">cantidad = 5</code> y <code class="text-indigo-300">precio = 200</code>. Imprimir cada variable en su propia línea con el formato <em>NombreVariable: valor</em>.</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">Cantidad: 5<br>Precio: 200</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
...
<br><span class="text-slate-500">// Imprime: Vuelta 1 / Vuelta 2 / Vuelta 3</span></div><div class="bg-amber-900/30 border border-amber-700/40 rounded-lg p-3 text-sm text-amber-200 mb-3">  💡 Diferencia clave: si la condición es falsa desde el inicio, <strong>while</strong> no ejecuta nada, pero <strong>do-while</strong> ejecuta el bloque una vez igual.</div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> Usar un do-while para imprimir los números del 1 al 4, uno por línea. La condición debe ir al final del bloque.</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">1<br>2<br>3<br>4</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
\n        int i = 1;
...
|&nbsp;
 <strong>int / double / String</strong> = devuelve ese tipo</div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> Crear <code class="text-indigo-300">static double calcularArea(double base, double altura)</code> que retorne el área de un triángulo (base × altura / 2). Llamarla con base=6 y altura=4 e imprimir el resultado con el formato <code class="text-yellow-300">Área: valor</code>.</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">Área: 12.0</code></div>`,    starterCode: `public class Main {
...
<br><span class="text-purple-400">int</span> nota = (<span class="text-purple-400">int</span>) promedio;
 <span class="text-slate-500">// 7</span></div><div class="bg-amber-900/30 border border-amber-700/40 rounded-lg p-3 text-sm text-amber-200 mb-3">  ⚠️ El cast <strong>trunca</strong> los decimales (los descarta). 7.9 se convierte en 7, no en 8.</div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> Dividir 10 entre 3 de dos formas: división entera y con cast. Imprimir:<br>  <code class="text-yellow-300">División entera: 3<br>Con cast: 3</code></div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">División entera: 3<br>Con cast: 3</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
...
</code>) no hay diferencia. La diferencia solo aparece cuando el resultado se usa en una expresión.</div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> El código ya está escrito. Predecir los valores e imprimir para comprobar:<br>  <code class="text-yellow-300">a: 5 — i: 6<br>b: 6 — j: 6</code></div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">a: 5 — i: 6<br>b: 6 — j: 6</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
\n        int i = 5;
\n        int a = i++;
...
<br>}
<span class="text-slate-500"> // 1,1 1,2 1,3 / 2,1 2,2 2,3 / 3,1 3,2 3,3</span></div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> El código ya está completo. Ejecutar y verificar que imprime las tablas de multiplicar del 2 y del 3 (del ×1 al ×5).</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">2 x 1 = 2<br>2 x 2 = 4<br>2 x 3 = 6<br>2 x 4 = 8<br>2 x 5 = 10<br>3 x 1 = 3<br>3 x 2 = 6<br>3 x 3 = 9<br>3 x 4 = 12<br>3 x 5 = 15</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
...
<span class="text-purple-400">return</span> a + b;
<br>}
<br><span class="text-slate-500">// sumar(3, 4)      → usa la versión int → 7</span><br><span class="text-slate-500">// sumar(3.5, 2.1)  → usa la versión double → 5.6</span></div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> El código ya tiene dos versiones de <code class="text-yellow-300">describir</code>. Ejecutar y ver cómo Java elige cuál usar:<br>  <code class="text-yellow-300">Número: 42<br>Texto: Hola</code></div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">Número: 42<br>Texto: Hola</code></div>`,    starterCode: `public class Main {
...
,  // ══ TEMA 31: Desafíos Finales ═════════════════════════════════════════════════
  {
 id: 61, title: "Patrón de números", subtitle: "Triángulo numérico",    explanation: `<h2 class="text-base font-bold mb-3">Desafío: Patrón de números</h2><p class="text-slate-300 text-sm mb-4">Usar bucles anidados para imprimir un triángulo donde cada fila muestra los números del 1 hasta el número de la fila.</p><div class="bg-slate-800/60 rounded-lg p-4 mb-4 mono text-sm text-slate-300 leading-7"><span class="text-slate-500">// Salida esperada:</span><br><span class="text-orange-300">1</span><br><span class="text-orange-300">1 2</span><br><span class="text-orange-300">1 2 3</span><br><span class="text-orange-300">1 2 3 4</span><br><span class="text-orange-300">1 2 3 4 5</span></div><div class="bg-indigo-900/30 border border-indigo-700/40 rounded-lg p-3 text-sm text-indigo-200">  <span class="font-bold">🎯 Tarea:</span> El código ya está completo. Ejecutar y verificar que imprime el triángulo numérico de 5 filas (cada fila del 1 hasta el número de fila).</div><div class="bg-emerald-900/30 border border-emerald-700/40 rounded-lg p-3 text-sm text-emerald-200 mt-3">  <span class="font-bold">📤 Salida esperada:</span><br>  <code class="text-emerald-100">1<br>1 2<br>1 2 3<br>1 2 3 4<br>1 2 3 4 5</code></div>`,    starterCode: `public class Main {
\n    public static void main(String[] args) {
